...
import {getElectronicsCollection} from "../../../../redux/products/products.actions";
...
let ElectronicsCollection = () => {
    ...
    useEffect(() => {
        // dispatch an action to get kid's collection when the page loads
        dispatch(getElectronicsCollection());
    }, [dispatch]);
            ...
            <section className="p-3 bg-brains">
                <div className="container ">
                    <div className="row animated flipInY">
                        <div className="col">
                            <p className="h3">Electronics Collection</p>
                        </div>
                    </div>
                </div>
            </section>
