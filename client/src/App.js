...
import ElectronicsCollection from "./modules/products/components/electronics-collection/Electronics"
    ...
    <div className="App">
      <Router>
        ...
        <Switch>
          ...
          <Route exact path="/products/electronics" component={ElectronicsCollection}/>
