import {
    ...
    ELECTRONICS_PRODUCT_REQUEST,ELECTRONICS_PRODUCT_SUCCESS, ELECTRONICS_PRODUCT_FAILURE
...
let productReducer = (state = initialState , action) => {
    ...
    switch(type) {
        ...
        case ELECTRONICS_PRODUCT_REQUEST :
            return  {
                ...state,
                loading:  true
            };
        case ELECTRONICS_PRODUCT_SUCCESS :
            return  {
                ...state,
                loading:  false,
                products: payload
            };
        case ELECTRONICS_PRODUCT_FAILURE :
            return  {
                ...state,
                loading:  false,
                errorMessage: payload
